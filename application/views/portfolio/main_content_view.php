...
#slide2{ 
background-image:url(/img/monblanc4.jpg);
background-size:100%;
...
<h1 id="last_works_header" class="medium_header">Latest works</h1>
 <div id="content">
		...
		<ul id="preview_main_block">
			<li class="preview" id="port_0">
				<div class="prev_img">	
					...
					<img class="main_preview" src="/img/wisdom_preview2.png" ></img>
					<a href="http://wisdom-services.net"><div class="link_block1">
					<div class="link"></div>
					</div></a>
					<img class="main_preview" src="/img/smile_preview.png"></img>
			...
			<li class="preview" id="port_1">
				<div class="prev_img">	
					<img class="main_preview" src="/img/eco_preview.png"  ></img>
					<img class="main_preview" src="/img/midia_preview.png"  ></img>
					<a href="http://midia.com.ua"><div class="link_block2">
					<div class="link"></div>
					</div></a>
				</div>
			</li>
			<li class="preview" id="port_2">
				<div class="prev_img">	
					<img class="main_preview" src="/img/ellada_preview.png"  ></img>
					<img class="main_preview" src="/img/blago_preview.png"  ></img>
				</div>
			</li>
		    <li class="preview" id="port_3">
				<div class="prev_img">	
					<img class="main_preview" src="/img/chernomorec_preview2.png" ></img>
					<img class="main_preview" src="/img/size_preview.png"  ></img>
				</div>
			</li>
		    <li class="preview" id="port_4">
				<div class="prev_img">	
					<img class="main_preview" src="/img/vsgroup_preview.png" ></img>
					<img class="main_preview" src="/img/persey_preview.png"  ></img>
				</div>
			</li>
			<li class="preview" id="port_5">
				<div class="prev_img">	
					<img class="main_preview" src="/img/pinokio_preview2.png" ></img>
					<img class="main_preview" src="/img/greece_preview.png"  ></img>
				</div>
			</li>
</ul>
